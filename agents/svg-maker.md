...
2. **Write the source** as a complete `<svg>…</svg>` with explicit
...
5. **Iterate** with the available editor and re-render until correct and clean.
   If rendering returns an error, read it, fix the source, and re-render.
